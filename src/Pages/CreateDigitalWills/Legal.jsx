            ...
            <div>
                ...
                <div className="relative">
                    <input
                        ...
                        className=" px-4 py-3  border border-[#BA927D] text-gray-700 rounded-lg focus:ring-2 focus:ring-[#CB7548] focus:border-[#CB7548] outline-none transition-colors"
                    />
                    <div className="absolute inset-y-0 left-30 flex items-center pr-3 pointer-events-none">
